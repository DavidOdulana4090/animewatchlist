        ...
        <>
            <div className='container-container-createaccount'>
                <div className='container-createaccount'>
                    ...
                    <InputField placeholder="Enter email address" id="enter-email" ref={emailref}/>
                    <br></br>

                    <div className='password-input-wrapper'>
                    <Label text="Password" className="createaccountlabel"/>
                        <InputField placeholder="Enter password" id="enter-password-field" type={showpassword ? "text" : "password"} ref={passwordref} />
                    ...
                    <Label text="Confirm password" className="createaccountlabel"/>
                        <InputField placeholder="confirm password" id="confirm-password-field" type={showPasswordConfirm ? "text" : "password"} ref={confirmpasswordref} />
